...
mixin FxColor {
  ...
  static const Color kcDangerStatus = Color(0xFFDE5050);
  static const Color kcSuccessStatus = Color(0xFF37BC64);

  // Light Status Colors
  static const Color kcWarningLightStatus = Color(0xFFFFF8DE);
  static const Color kcDangerLightStatus = Color(0xFFFFF3F3);
  static const Color kcSuccessLightStatus = Color(0xFFE2F8E9);
